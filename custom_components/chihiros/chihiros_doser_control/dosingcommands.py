...
matching the shapes seen in your captures/logs. It intentionally avoids any
extra behavior beyond what the device supports.
...
compatibility. Anything not present in the logs or confirmed behavior is omitted.
"""
